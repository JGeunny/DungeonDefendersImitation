...
_bool Engine::CFrustum::Is_InFrustum(const _vec3* pPos, const _float fRadius)
{
	_float	fDistance = 0.f;
...
_bool Engine::CFrustum::Is_InFrustum_ForObject(const _vec3* pPos, const _float fRadius)
{
	Ready_Frustum();
